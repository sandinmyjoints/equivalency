...
const { FunctionRule, RemoveRule, punctuationAsWhitespaceFactory} = require('./rules');
...
module.exports = {
  ...
  INFINITIVE_VERBS,
  PUNCTUATION_AS_WHITESPACE: punctuationAsWhitespaceFactory(COMMON_PUNCTUATION_STR)
};
